...
def generate_launch_description():
    ...
    xacro_setrings = PathJoinSubstitution([robot_pkg, 'model', 'lifter_mover.urdf.xacro'])    
    srdf_settings = PathJoinSubstitution([robot_pkg, 'moveit', 'config', 'SEED-Lifter-Mover-typeG.srdf'])
